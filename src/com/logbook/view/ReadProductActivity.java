...
public class ReadProductActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		linearLayout = (LinearLayout) findViewById(R.id.linearLayout_read_product);
		...
		simpleList = new SimpleList(this, items, sql, "ReadProductActivity");
